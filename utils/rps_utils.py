...
class RockPaperScissors(View):
    ...
    async def rock_callback(self, interaction: Interaction, button: Button) -> None:
        if self.ai == "Rock":
            await interaction.response.send_message(f"You chose: **Rock**\nAI chose: **{self.ai}**\n\nResult: **IT'S A TIE!**")
    ...
    async def paper_callback(self, interaction: Interaction, button: Button) -> None:
        if self.ai == "Rock":
            await interaction.response.send_message(f"You chose: **Paper**\nAI chose: **{self.ai}**\n\nResult: **YOU WON!**")
    ...
    async def scissors_callback(self, interaction: Interaction, button: Button) -> None:
        if self.ai == "Rock":
            await interaction.response.send_message(f"You chose: **Scissors**\nAI chose: **{self.ai}**\n\nResult: **AI WON!**")
